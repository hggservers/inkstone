export const EN_US_MESSAGES = {
    "reports.title_prefix": "Income Intelligence Daily | ",
    "integrations.title": "API access",
    "integrations.description": "Create a token for daily report read/write access to one folder. Tokens cannot delete notes or access other folders.",
    "integrations.name": "Token name",
    "integrations.folder": "Allowed folder",
    "integrations.expiry": "Validity (days, 1–365)",
    "integrations.create": "Create token",
    "integrations.revoke": "Revoke",
    "integrations.once": "Copy now. This token is shown only once.",
    "integrations.active": "Active",
    "integrations.expired": "Expired or revoked",
    "integrations.loading": "Loading…",
    "integrations.audit": "Recent API calls",
    "integrations.empty": "No API tokens yet.",
    ...
    "workspace.export_html": "Export HTML",
    "workspace.export_markdown": "Export Markdown",
    "workspace.export_note": "Export note",
    ...
    "workspace.print_save_pdf": "Print / Save as PDF",
    "workspace.print_window_blocked": "Could not open the print window. Allow pop-ups for this site and try again.",
